...
public class OptionDialog extends JDialog implements ActionListener {
	...
	public OptionDialog() {
		setTitle("HavenCraft Launcher Settings");
		...
		buildInfo.setText("HavenCraft Launcher Build " + Main.build);
		buildInfo.setOpaque(true);
		buildInfo.setForeground(Color.DARK_GRAY);
		buildInfo.setToolTipText("Created by the Spout Development Team and Modified by the HavenCraft Team. Licensed under the LGPL. Source code is available at www.github.com/SpoutDev");
